...
build_target () { 
    DOCKER_LABEL="$DOCKER_REPO_PREFIX"/lightaurora-"$MODULE":"$DOCKER_TAG"
    docker build --tag $DOCKER_LABEL --platform linux/amd64 -f "exp/lightaurora/build/$MODULE/Dockerfile" . 
