...
func TestNormalizeResponseBody(t *testing.T) {
	...
	"_links": {
	  "self": {
		"href": "https://aurora-testnet.hcnet.org/transactions?cursor=\u0026limit=1\u0026order=desc"
	  },
	  "next": {
		"href": "https://aurora-testnet.hcnet.org/transactions?cursor=2892102128111616\u0026limit=1\u0026order=desc"
	  },
	  "prev": {
		"href": "https://aurora-testnet.hcnet.org/transactions?cursor=2892102128111616\u0026limit=1\u0026order=asc"
	  }
	},
	"_embedded": {
	  "records": [
		{
		  "_links": {
			"self": {
			  "href": "https://aurora-testnet.hcnet.org/transactions/cfc6395b98ed0c5ad63bd808e6b5ec994c3ccc67814945d3c652659b5077da18"
			},
			"account": {
			  "href": "https://aurora-testnet.hcnet.org/accounts/GBW7BTQDKVMB62NXB3Z55NZCENRBD4O4OE7YBKBOG4K4DM4QK76L2DJD"
			},
			"ledger": {
			  "href": "https://aurora-testnet.hcnet.org/ledgers/673370"
			},
			"operations": {
			  "href": "https://aurora-testnet.hcnet.org/transactions/cfc6395b98ed0c5ad63bd808e6b5ec994c3ccc67814945d3c652659b5077da18/operations{?cursor,limit,order}",
			  "templated": true
			},
			"effects": {
			  "href": "https://aurora-testnet.hcnet.org/transactions/cfc6395b98ed0c5ad63bd808e6b5ec994c3ccc67814945d3c652659b5077da18/effects{?cursor,limit,order}",
			  "templated": true
			},
			"precedes": {
			  "href": "https://aurora-testnet.hcnet.org/transactions?order=asc\u0026cursor=2892102128111616"
			},
			"succeeds": {
			  "href": "https://aurora-testnet.hcnet.org/transactions?order=desc\u0026cursor=2892102128111616"
			},
			"transaction": {
			  "href": "https://aurora-testnet.hcnet.org/transactions/cfc6395b98ed0c5ad63bd808e6b5ec994c3ccc67814945d3c652659b5077da18"
			}
