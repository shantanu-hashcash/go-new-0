...
const (
	// PreflightStatusError represents the status value returned by hcnet-core when an error occurred from
	// processing a preflight request
	PreflightStatusError = "ERROR"

	// PreflightStatusOk represents the status value returned by hcnet-core when a preflight request
	// succeeded
